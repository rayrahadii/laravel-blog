            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item text-muted active">Post List
                        </li>
                    </ol>
                </nav>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            @endif
                <div class="btn-list">
                <a href="{{ route('post.create') }}" class="btn btn-primary btn-rounded"><i class="fas fa-plus"></i> Tambah Post</a>
                </div>
                <br>
                            ...
                            <tr>
                                ...
                                <td class="text-center" width="150px">
                                        ...
                                        <form action="{{ route('post.destroy', $result->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
                                            <a href="{{ route('post.edit', $result->id) }}" class="btn btn-success btn-circle">
